...
- Default branch: main
- Active extensions: vibecode-skills-viewer, vibecode-right-click-action-open-to-file, vibecode-right-click-sh-actions, vibecode-agent-init-this-folder, vibecode-env-import-only, vibecode-commit-lint-check, vibecode-extension-menu-list
