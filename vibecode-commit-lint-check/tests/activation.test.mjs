// Headless activation smoke-test (vibecode-extension-testing skill Layer 1).
// Loads dist/extension.js with a stubbed `vscode` module and verifies activate()
// completes without throwing, then asserts every declared view has a provider
// and every declared command got registered.
...
const EXPECTED_VIEWS = [
  'vibecodeCommitLint.checks',
  'vibecodeCommitLint.templates',
];
const EXPECTED_COMMANDS = [
  // From src/apps/*/manifest.ts (12 apps)
  'vibecodeCommitLint.initFromTemplate',
  'vibecodeCommitLint.addTemplate',
  'vibecodeCommitLint.applyTemplate',
  'vibecodeCommitLint.openSettings',
  'vibecodeCommitLint.revealChecksFolder',
  'vibecodeCommitLint.refreshChecks',
  'vibecodeCommitLint.showCheckOutput',
  'vibecodeCommitLint.runAllChecks',
  'vibecodeCommitLint.runCheck',
  'vibecodeCommitLint.refreshTree',
  'vibecodeCommitLint.checkLastCommit',
  'vibecodeCommitLint.scaffoldDefaultChecks',
];
